# -*- coding: utf-8 -*-
"""CrossAttnRNNDemand.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/19LHnixaRM_WDmFIRrHY8eTPzzq6ohlfw
"""
...
class ImageEncoder(nn.Module):
    ...
    def forward(self, x, batch_size):
        x = self.cnn(x)
        # if (x.shape[0]*x.shape[1]) % (64*2048) == 0:
        #   x = x.view(64, -1, 2048)
        # else:
        #   x = x.view(38, -1, 2048)
...
class CrossAttnRNN(pl.LightningModule):
    ...
    def forward(
        ...
        img_encoding = self.image_encoder(images, batch_size)
