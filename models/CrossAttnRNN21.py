# -*- coding: utf-8 -*-
"""CrossAttnRNN21.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1QyxGOnfB-QQYKYztjJcuCUeRC_Zsb0jd
"""
...
class CrossAttnRNN(pl.LightningModule):
    ...
    def forward(self, X, y, images):
        ...
        if self.use_img:
            ...
            attended_img_encoding = attended_img_encoding.repeat_interleave(num_ts_splits, dim=0)
            x = x + attended_img_encoding.sum(1)
