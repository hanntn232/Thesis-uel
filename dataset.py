...
Original file is located at
    https://colab.research.google.com/drive/15psKOn0M4FpJx5MlDzsFYk8WkaMMWS_R
"""
...
class Visuelle2:
    def __init__(
        ...
        # Replace negative values in sales dataset
        sales_df.iloc[:,-12:] = sales_df.iloc[:,-12:].clip(lower=0)
    ...
    def frame_series(self, forecast_horizon=1):
        train_window = 4 if self.new_window == True else 2
        X, y = [], []
